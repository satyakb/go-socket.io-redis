...
type RedisAdapterConnectOptions struct {
	Host     string
	Port     string
	Password string
	Prefix   string
...
func Redis(op RedisAdapterConnectOptions) socketio.BroadcastAdaptor {
	b := broadcast{
